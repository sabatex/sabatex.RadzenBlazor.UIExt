...
public interface IRadzenDataAdapter
{
    ...
    Task FillData<TItem>(RadzenODataCollection<TItem>? dataCollection, LoadDataArgs args, string? expand=null,IEnumerable<FieldDescriptor>? filterFields = null) where TItem : class;
...
public record struct  FieldDescriptor(string Name,Type FieldType);
